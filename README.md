# 自定义大逃杀扩展：极械工坊 | CBR Addon: MachineMax

[中文](#自定义大逃杀扩展极械工坊) | [English](#cbr-addon-machinemax)

# 自定义大逃杀扩展：极械工坊

本模组是[自定义大逃杀](https://github.com/XColorful/BattleRoyale)的扩展模组。
- 提供[极械工坊](https://github.com/Sweetzonzi/Machine-Max)扩展功能
...
# CBR Addon: MachineMax

This mod is an addon mod for [Custom BattleRoyale](https://github.com/XColorful/BattleRoyale).
- Provides extended features of [MachineMax](https://github.com/Sweetzonzi/Machine-Max)
